...
//how much time has passed from the moment a button was down?
//(short possibly long press detection)
...
static const char S_USB_ON[] = "USB_ON  ";
static const char S_USB_OFF[] = "USB_OFF ";
...
* - handles transitions between different states using a finite state machine
      ...
      if (USB_isConnected())
      {
        ...
        {  
          if (USB_readyToWrite())
          {
            ...
            usb_puts("\033[2J\033[;H");     //clear the terminal
            usb_buffer[2] = ' '; //we do not care about the ":" anyway
